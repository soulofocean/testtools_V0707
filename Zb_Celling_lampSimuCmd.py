...
from basic.BasicSimuCmd import BasicCmd,Celling_lamp,Load_zb_ini_file
from basic.BasicProtocol import ZIGBEE
import ConfigParser


class Celling_lampCmd(BasicCmd):
...
if __name__ == '__main__':
    ...
    zigbee_obj.set_device(eval("Celling_lamp"))
    cmd = Celling_lampCmd(logger=LOG, cprint=cprint)
    cmd.cmdloop()